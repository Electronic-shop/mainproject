            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="index.html">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span><a href="index1.php">D - ESHOP</a> </span></a></div>
                    <li class="label">Manage</li>
                    <li><a class="sidebar-sub-toggle"><i class="ti-home"></i> Manage <span
                                class="badge badge-primary">3</span> <span
                                class="sidebar-collapse-icon ti-angle-down"></span></a>
                        <ul>
                        <li><a href="index1.html">Manage User's</a></li>
